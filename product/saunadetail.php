...
<html lang="ja">
    ...
    <body>
        ...
        <form method="POST" action="insert.php" enctype="multipart/form-data">
            <div class="jumbotron">
                <fieldset>
                    ...
                    <label>場所<input type="text" name="address" value="<?=$row["address"]?>"></label><br>
                    <label>人気度<input type="text" name="famous" rows="4" cols="40" value="<?=$row["famous"]?>"></label><br>
        ...
        <div class="jumbotron">
            <img src="https://www.sayanoyudokoro.co.jp/wp-content/themes/sayanoyudokoro/files/images/home/img_int1.jpg"  alt="">
            <legend>[編集]</legend>
            <label>店名<input type="text" name="name" value="<?=$row["name"]?>"></label><br>
            <label>場所<input type="text" name="address" value="<?=$row["address"]?>"></label><br>
            <label>人気度<input type="text" name="famous" value="<?=$row["famous"]?>"></label><br>
            <label>料金<textArea name="fee" rows="4" cols="40"><?=$row["fee"]?></textArea></label><br>
